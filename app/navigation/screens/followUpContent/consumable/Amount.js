...
export default function Amount({ navigation, route }) {
    ...
    const handleConfirm = () => {
        if (amount.trim() === '') {
            ...
            navigation.navigate('ConfirmConsumable', {
                accountNumber: route.params.accountNumber,
                expenditureType: route.params.expenditureType,
                selectedOption: route.params.selectedOption,
                payBillNumber: route.params.payBillNumber,
                expenditureAccount: route.params.expenditureAccount,
                amount,
                clearAmount: true,
            });
        }
    ...
    useEffect(() => {
        if (isFocused) {
            console.log('Amount page is focused');
            console.log('Data from AccountNumber:', route.params);
        }
